...
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'False', '2020-20-02', 'False', 'Theresa Hebert')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'True', '2020-07-02', 'False', 'Veronica Campos')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'False', '2020-07-02', 'True', 'Diana Shelton')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'True', '2020-07-02', 'True', 'Jesse Burns')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'False', '2020-07-02', 'False', 'Hazel Oneill')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'True', '2020-07-02', 'False', 'Morgan Melendez')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'False' ,'2020-07-02', 'False', 'Victoria Contreras')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'True', '2020-07-02', 'False', 'Aleena Knapp')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'False', '2020-07-02', 'False', 'Irene Weiss')
insert into dbo.Users (dateOfBirth, gender, lastVisit, isOnline, name) values ('1987-20-02', 'True', '2020-07-02', 'False', 'Tiana Watson')
